...
Теги должны сортироваться по использованию и добавлению. (not in mvp)
Добавить возможность добавлять новые теги, сканируя их из старых постов. (not in mvp)
Добавить возможность добавлять сразу несколько новых тегов в одном сообщении.

При удалении тега из Сервиса, удалять тег из всех постов в очереди (желательно из всех постов в канале) (not in mvp)
...
Можно убирать авторство подписчика, если тот подтвердит своё согласие на это. (not in mvp)
...
3. Согласиться или не соглашаться с указанием авторства и ссылки на аккаунт Подписчика <br> (not in mvp)
...
- Бекэнд
  - Язык Python
    ...
    - Библиотека для управления Б/Д SQLAlchemy
  - Б/Д PostgreSQL
- Фронтэнд:
  - Язык Python
